...
* Changed: Enable cloning from wp.a2z to wp-a2z.org,[github bobbingwide fizzie issues 48]
* Changed: Remove empty paragraph from page footer,[github bobbingwide fizzie issues 4]
* Changed: Update 'naughty' message from index.php
* Changed: Update screenshot for v0.1.1
* Fixed: Add text domain to 'No posts found'
* Fixed: Update home.html to use header.html,[github bobbingwide fizzie issues 36]

= 0.1.1 =
* Added: Create archive templates & a2z pagination parts for block & oik-plugins,[github bobbingwide fizzie issues 36]
* Added: Debug information for each template,[github bobbingwide fizzie issues 41]
* Changed: Add social links in the footer,[github bobbingwide fizzie issues 4]
* Changed: Copy images from genesis-a2z; even if not actually used,[github bobbingwide fizzie issues 4]
* Changed: Improve styling of footer.,[github bobbingwide fizzie issues 4]
* Changed: Set min-height 60px for h2 on post-type-archive-block only.,[github bobbingwide fizzie issues 4]
* Changed: The About menu item should link to the about page,[github bobbingwide fizzie issues 17]
* Changed: Try to properly implement alignwide and alignfull styling capability,[github bobbingwide fizzie issues 44]
* Fixed: Add a shim to enable Navigation menus to display in the Front end on WordPress 5.6-RC1,[github bobbingwide issues 42]
* Fixed: Correct [sites] shortcode to [bw_blogs],[github bobbingwide fizzie issues 4]
* Fixed: Correct reference to $this->bad_processed_content,[github bobbingwide fizzie issues 36]
...
* Changed: Extracted header and footer menus into separate template parts [[github bobbingwide fizzie issues 17] 
...
* Changed: Style page-footer content to be same width as page and post,[github bobbingwide fizzie issues 1]
...
For more information see [github bobbingwide fizzie issue 25] and/or the includes folder. 
